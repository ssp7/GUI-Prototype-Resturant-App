...
public class Controller {
	...
	public void cardNo_String(ActionEvent event) {
		...
		cardNo_String = cardNo.getText();
		int a = Integer.parseInt(cardNo.getText());

	}

	public void expiration_String(ActionEvent event) {
		expiration_String = expiration.getText();
		System.out.println(expiration_String);
	}

	public void CVV_String(ActionEvent event) {
		CVV_String  = CVV.getText();
	}

	public void ZipCode_String(ActionEvent event) {
		Zip_Code_String = Zip_Code.getText();
	}

	public void verify(ActionEvent event) throws InputMismatchException, IOException {
		boolean check = true;
		try {
			int a = Integer.parseInt(cardNo_String);
			int b = Integer.parseInt(expiration_String);
			int c = Integer.parseInt(CVV_String);
			int d = Integer.parseInt(Zip_Code_String);		
